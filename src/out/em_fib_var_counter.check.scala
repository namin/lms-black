...
class staged$0 extends Fun[NoRep] with (Value => Value) {
  ...
  def fun[R[_]:Ops](x0:Value)(implicit ev: Convert[NoRep,R]): R[Value] = {
    ...
    val x1 = o._car(x0)
    val x2 = x1
    val x5 = o._cell_read(o._lift(Cell("counter")))
    val x6 = o._cons(x5, o._lift(P(I(1), N)))
    val x71 = o._app(o._lift(Prim("+")), x6,
    o._cont(new FunC[R] { def fun[R1[_]:Ops](implicit ev_1: Convert[R,R1]) = {(x7: R1[Value]) =>
        ...
        val x8 = o1._cell_set(o1._lift(Cell("counter")), x7)
        val x10 = x1
        val x11 = o1._cons(x10, o1._lift(P(I(2), N)))
        val x69 = o1._app(o1._lift(Prim("<")), x11,
        o1._cont(new FunC[R1] { def fun[R2[_]:Ops](implicit ev1_2: Convert[R1,R2]) = {(x12: R2[Value]) =>
            ...
            val x13 = o2._true(x12)
            val x67 = o2._if((x13), {
              val x14 = o2._cell_read(o2._lift(Cell("counter")))
              val x15 = o2._cons(x14, o2._lift(P(I(1), N)))
              val x21 = o2._app(o2._lift(Prim("+")), x15,
              o2._cont(new FunC[R2] { def fun[R3[_]:Ops](implicit ev2_3: Convert[R2,R3]) = {(x16: R3[Value]) =>
                  ...
                  val x17 = o3._cell_set(o3._lift(Cell("counter")), x16)
                  val x19 = x1
                  x19: R3[Value]
              }})
              )
              ...
              val x25 = o2._cell_read(o2._lift(Cell("fib")))
              val x27 = o2._cell_read(o2._lift(Cell("counter")))
              val x28 = o2._cons(x27, o2._lift(P(I(1), N)))
              val x65 = o2._app(o2._lift(Prim("+")), x28,
              o2._cont(new FunC[R2] { def fun[R3[_]:Ops](implicit ev2_3: Convert[R2,R3]) = {(x29: R3[Value]) =>
                  val o3 = implicitly[Ops[R3]]; implicit def convert_ev2_3(x: R2[Value]): R3[Value] = ev2_3.convert(x); val ev1_3: Convert[R1,R3] = convertTrans[R1,R2,R3](ev1_2, ev2_3); implicit def convert_ev1_3(x: R1[Value]): R3[Value] = ev1_3.convert(x); val ev_3: Convert[R,R3] = convertTrans[R,R1,R3](ev_1, ev1_3); implicit def convert_ev_3(x: R[Value]): R3[Value] = ev_3.convert(x);
                  val x30 = o3._cell_set(o3._lift(Cell("counter")), x29)
                  val x32 = x1
                  val x33 = o3._cons(x32, o3._lift(P(I(1), N)))
                  val x63 = o3._app(o3._lift(Prim("-")), x33,
                  o3._cont(new FunC[R3] { def fun[R4[_]:Ops](implicit ev3_4: Convert[R3,R4]) = {(x34: R4[Value]) =>
                      ...
                      val x35 = o4._cons(x34, o4._lift(N))
                      val x61 = o4._app(x25, x35,
                      o4._cont(new FunC[R4] { def fun[R5[_]:Ops](implicit ev4_5: Convert[R4,R5]) = {(x36: R5[Value]) =>
                          ...
                          val x38 = o5._cell_read(o5._lift(Cell("fib")))
                          val x40 = o5._cell_read(o5._lift(Cell("counter")))
                          val x41 = o5._cons(x40, o5._lift(P(I(1), N)))
                          val x59 = o5._app(o5._lift(Prim("+")), x41,
                          o5._cont(new FunC[R5] { def fun[R6[_]:Ops](implicit ev5_6: Convert[R5,R6]) = {(x42: R6[Value]) =>
                              ...
                              val x43 = o6._cell_set(o6._lift(Cell("counter")), x42)
                              val x45 = x1
                              val x46 = o6._cons(x45, o6._lift(P(I(2), N)))
                              val x57 = o6._app(o6._lift(Prim("-")), x46,
                              o6._cont(new FunC[R6] { def fun[R7[_]:Ops](implicit ev6_7: Convert[R6,R7]) = {(x47: R7[Value]) =>
                                  ...
                                  val x48 = o7._cons(x47, o7._lift(N))
                                  val x55 = o7._app(x38, x48,
                                  o7._cont(new FunC[R7] { def fun[R8[_]:Ops](implicit ev7_8: Convert[R7,R8]) = {(x49: R8[Value]) =>
                                      ...
                                      val x50 = o8._cons(x49, o8._lift(N))
                                      val x51 = o8._cons(x36, x50)
                                      val x53 = o8._app(o8._lift(Prim("+")), x51,
                                      o8._cont(new FunC[R8] { def fun[R9[_]:Ops](implicit ev8_9: Convert[R8,R9]) = {(x52: R9[Value]) =>
                                          x52: R9[Value]
                                      }})
                                      )
                                      x53: R8[Value]
