  ...
  def fun[R[_]:Ops](x0:Value)(implicit ev: Convert[NoRep,R]): R[Value] = {
    ...
    val x43 = o._fun(new Fun[R] { def fun[R1[_]:Ops](implicit ev_1: Convert[R,R1]) = {(x4: R[Value]) =>
        ...
        val x41 = o1._fun(new Fun[R1] { def fun[R2[_]:Ops](implicit ev1_2: Convert[R1,R2]) = {(x8: R1[Value]) =>
            ...
            val x39 = o2._app(o2._lift(Prim("<")), x13,
            o2._cont(new FunC[R2] { def fun[R3[_]:Ops](implicit ev2_3: Convert[R2,R3]) = {(x14: R3[Value]) =>
                ...
                val x37 = o3._if((x15), {
                  ...
                  o3._cont(new FunC[R3] { def fun[R4[_]:Ops](implicit ev3_4: Convert[R3,R4]) = {(x19: R4[Value]) =>
                      ...
                      val x20 = x5
                      val x21 = x9
                      val x22 = o4._cons(x21, o4._lift(P(I(1), N)))
